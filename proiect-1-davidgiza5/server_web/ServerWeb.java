	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			try {
				...
				// socketWriter - wrapper peste fluxul de iesire folosit pentru a transmite date clientului
				...
				// la apelul metodei close() se inchid automat fluxurile de intrare si iesire (socketReader si socketWriter)
				clientSocket.close();
